...
Sluger is a powerful WordPress plugin that automatically generates clean and SEO-friendly URLs (slugs) for your posts and pages. It's especially useful for websites using non-Latin languages like Chinese, Japanese, etc.
...
1. Upload the plugin files to the `/wp-content/plugins/wp-sluger` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Use the Settings->Sluger screen to configure the plugin
4. Choose your preferred translation service and configure the API settings
...
= 0.0.1 =
Initial release of Sluger plugin.
